...
export class ShowProductoComponent implements OnInit {
      ...
      this._guestService
        ...
        .subscribe((response) => {
          ...
          if (response.data != undefined) {
            ...
            this._guestService.get_categorias().subscribe((response) => {
            ...
            this._guestService
              .obtener_reviews_producto_publico(this.producto._id)
              .subscribe((response) => {
  ...
  init_variedades() {
    this._guestService
      .obtener_variedades_productos_cliente(this.producto._id)
      .subscribe((response) => {
      ...
      if (this.carrito_data.cantidad >= 1) {
        if (this.carrito_data.cantidad <= this.obj_variedad_select.stock) {
          ...
          iziToast.show({
            ...
            position: 'topRight',
            message:
              'La cantidad máxima del producto es.' +
              this.obj_variedad_select.stock,
          });
        }
      } else {
        iziToast.show({
